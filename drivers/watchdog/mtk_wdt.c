...
#include <dt-bindings/reset/mediatek,mt6757-wdt.h>
...
static const struct mtk_wdt_data mt6757_data = {
	.toprgu_sw_rst_num = MT6757_TOPRGU_RST_NUM,
};
...
static const struct of_device_id mtk_wdt_dt_ids[] = {
	...
	{ .compatible = "mediatek,mt6757-wdt", .data = &mt6757_data },
