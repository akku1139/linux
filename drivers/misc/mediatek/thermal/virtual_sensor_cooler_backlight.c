...
#if (defined(CONFIG_THERMAL_CHECKERS) || defined(CONFIG_THERMAL_CROWN) || defined(CONFIG_THERMAL_CRONOS) || defined(CONFIG_THERMAL_abc123) || defined(CONFIG_THERMAL_abc123))
