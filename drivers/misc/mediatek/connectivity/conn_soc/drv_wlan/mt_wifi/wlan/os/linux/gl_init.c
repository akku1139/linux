...
static COUNTRY_POWER_TABLE power_table_biscuit[] = {
		{
			...
			0x24, 0x24, 0x24, 0x22, 0x22, 0x20, /* 5G_OFDM */
			0x24, 0x24, 0x24, 0x22, 0x22, 0x22, /* 5G_HT_20 */
			0x22, 0x22, 0x22, 0x22, 0x22, 0x22, /* 5G_HT_40 */
			},
			0x1,/*tx power valid flag*/
			{/*2.4G band edge power*/
			0x1, 0x24, 0x26, 0x0,
		...
		},
		{
			...
			0x24, 0x24, 0x24, 0x24, 0x24, 0x24,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x24, 0x24, 0x24, 0x22, 0x22, 0x20,
			0x24, 0x24, 0x24, 0x22, 0x22, 0x22,
...
static COUNTRY_POWER_TABLE power_table_abd123[] = {
		{
			...
			0x20, 0x20, 0x20, 0x20, 0x20, 0x20, /* 5G_HT_40 */
			},
			0x1,/*tx power valid flag*/
			{/*2.4G band edge power*/
			0x1, 0x1E, 0x20, 0x0,
...
struct board_id_power_table_map board_id_power_table_list[] = {
	...
	{BOARD_ID_abc123_STR, power_table_biscuit, ARRAY_SIZE(power_table_biscuit)},
...
/* prGlueInfo->rHifInfo.DmaOps->DmaRegDump(&prGlueInfo->rHifInfo); */
		...
		set_user_nice(prGlueInfo->main_thread, MIN_NICE);
