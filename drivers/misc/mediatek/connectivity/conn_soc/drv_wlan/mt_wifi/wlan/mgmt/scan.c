...
P_BSS_DESC_T scanSearchBssDescByPolicy(IN P_ADAPTER_T prAdapter, IN ENUM_NETWORK_TYPE_INDEX_T eNetTypeIndex)
{
	...
	DBGLOG(SCN, INFO, "SEARCH: Bss Num: %d, Look for SSID: XXXXXX, Band=%d, channel=%d\n",
			   (UINT_32) prBSSDescList->u4NumElem, eBand, ucChannel);
	DBGLOG(SSID, TRACE, "Look for SSID: %s, %pM\n", prConnSettings->aucSSID, (prConnSettings->aucBSSID));
