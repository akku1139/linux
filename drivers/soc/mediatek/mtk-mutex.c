...
#define MT6757_MUTEX_MOD_DISP_RDMA0		0
#define MT6757_MUTEX_MOD_DISP_RDMA1		1
#define MT6757_MUTEX_MOD_DISP_OVL0		13
#define MT6757_MUTEX_MOD_DISP_OVL1		14
#define MT6757_MUTEX_MOD_DISP_OVL0_2L		15
#define MT6757_MUTEX_MOD_DISP_OVL1_2L		16
#define MT6757_MUTEX_MOD_DISP_WDMA0		17
#define MT6757_MUTEX_MOD_DISP_WDMA1		18
#define MT6757_MUTEX_MOD_DISP_COLOR0		19
#define MT6757_MUTEX_MOD_DISP_CCORR0		21
#define MT6757_MUTEX_MOD_DISP_AAL0		23
#define MT6757_MUTEX_MOD_DISP_GAMMA0		25
#define MT6757_MUTEX_MOD_DISP_DITHER0		28
#define MT6757_MUTEX_MOD_DISP_UFOE		30
#define MT6757_MUTEX_MOD_DISP_PWM0		32
#define MT6757_MUTEX_MOD_DISP_DSI0		33
#define MT6757_MUTEX_MOD_DISP_DSI1		34
...
static const u8 mt6757_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	[DDP_COMPONENT_AAL0] = MT6757_MUTEX_MOD_DISP_AAL0,
	[DDP_COMPONENT_CCORR] = MT6757_MUTEX_MOD_DISP_CCORR0,
	[DDP_COMPONENT_COLOR0] = MT6757_MUTEX_MOD_DISP_COLOR0,
	[DDP_COMPONENT_DITHER0] = MT6757_MUTEX_MOD_DISP_DITHER0,
	[DDP_COMPONENT_DSI0] = MT6757_MUTEX_MOD_DISP_DSI0,
	[DDP_COMPONENT_DSI1] = MT6757_MUTEX_MOD_DISP_DSI1,
	[DDP_COMPONENT_GAMMA] = MT6757_MUTEX_MOD_DISP_GAMMA0,
	[DDP_COMPONENT_OVL0] = MT6757_MUTEX_MOD_DISP_OVL0,
	[DDP_COMPONENT_OVL1] = MT6757_MUTEX_MOD_DISP_OVL1,
	[DDP_COMPONENT_OVL_2L0] = MT6757_MUTEX_MOD_DISP_OVL0_2L,
	[DDP_COMPONENT_OVL_2L1] = MT6757_MUTEX_MOD_DISP_OVL1_2L,
	[DDP_COMPONENT_PWM0] = MT6757_MUTEX_MOD_DISP_PWM0,
	[DDP_COMPONENT_RDMA0] = MT6757_MUTEX_MOD_DISP_RDMA0,
	[DDP_COMPONENT_RDMA1] = MT6757_MUTEX_MOD_DISP_RDMA1,
	[DDP_COMPONENT_UFOE] = MT6757_MUTEX_MOD_DISP_UFOE,
	[DDP_COMPONENT_WDMA0] = MT6757_MUTEX_MOD_DISP_WDMA0,
	[DDP_COMPONENT_WDMA1] = MT6757_MUTEX_MOD_DISP_WDMA1,
};
...
static const struct mtk_mutex_data mt6757_mutex_driver_data = {
	.mutex_mod = mt6757_mutex_mod,
...
static const struct of_device_id mutex_driver_dt_match[] = {
	...
	{ .compatible = "mediatek,mt6757-disp-mutex", .data = &mt6757_mutex_driver_data },
