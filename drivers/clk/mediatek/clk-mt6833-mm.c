...
static const struct mtk_gate mm_clks[] = {
	...
	GATE_MM0(CLK_MM_DISP_CCORR1, "mm_disp_ccorr1", "disp_ck", 6),
	...
	/* MM1 */
	GATE_MM1(CLK_MM_DSI0_DSI_CK_DOMAIN, "mm_dsi0_dsi_domain", "disp_ck", 0),
	GATE_MM1(CLK_MM_DISP_26M, "mm_disp_26m_ck", "disp_ck", 10),
};

static const struct mtk_clk_desc mm_clks_desc = {
	.clks = mm_clks,
