...
#include <dt-bindings/clock/mediatek,mt6757-mfgcfg.h>
...
static const struct of_device_id of_match_mt6757_mfgcfg[] = {
	{ .compatible = "mediatek,mt6757-mfgcfg", .data = &mfgcfg_clks },
	{ /* sentinel */ }
};

static struct platform_driver clk_mt6757_mfgcfg = {
	.probe = mtk_clk_simple_probe,
	.remove = mtk_clk_simple_remove,
	.driver = {
		.name = "clk-mt6757-mfgcfg",
		.of_match_table = of_match_mt6757_mfgcfg,
	},
};
module_platform_driver(clk_mt6757_mfgcfg);

MODULE_AUTHOR("Ben Grisdale <bengris32@protonmail.ch>");
MODULE_DESCRIPTION("Mediatek MT6757 mfgcfg clock and reset driver");
MODULE_LICENSE("GPL");
