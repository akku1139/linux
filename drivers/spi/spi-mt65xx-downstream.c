...
#define CONFIG_MT_SND_SOC_8163_AMZN
...
static int mtk_spi_prepare_hardware(struct spi_controller *master)
{
...
MODULE_ALIAS("platform:mtk-spi-downstream");
